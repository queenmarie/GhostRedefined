...
system('cls');
system('title Admin Control Panel Finder Coded by Gh0st from www.hackerschool.fr');
 
print"\n";
print "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n" ;
print "                        Admin Control Panel Finder v 1 \n" ;
print "                             Coded By Gh0st\n" ;
print "                        website:www.hackerschool.fr\n\n" ;
print "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n" ;
print "\n";
